...
namespace Eyeware.BeamEyeTracker.Unity
{
    ...
    /// </summary>
    public class UIElementReact : BeamEyeTrackerMonoBehaviour
    {
        ...
        public bool isLookingAtThis = true;
        ...
        void Update()
        {
            ...
            if (!isLookingAtThis)
            {
                // Debug.Log($"User is likely not looking at {gameObject.name} (position: {onScreenPosition}, likelihood: {likelihoodOfUserLookingThis}), fading out.");
